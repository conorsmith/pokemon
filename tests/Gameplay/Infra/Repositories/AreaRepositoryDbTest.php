...
namespace ConorSmith\PokemonTest\Gameplay\Infra\Repositories;
...
final class AreaRepositoryDbTest extends TestCase
{
    #[Test]
    function it_finds_an_area_with_a_single_location()
    {
        ...
        $repo = new AreaRepositoryDb($battleRepo->reveal(), $trainerRepo->reveal(), new LocationConfigRepository($locationConfig));
    ...
    function it_cannot_find_an_area()
    {
        ...
        $repo = new AreaRepositoryDb($battleRepo->reveal(), $trainerRepo->reveal(), new LocationConfigRepository(new WeakMap()));
