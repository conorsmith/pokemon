...
final class PostLogStretchesTest extends TestCase
{
    #[Test]
    function processes_request()
    {
        ...
        $response = Website::post("/log/stretches", [
            'date' => "2023-01-01",
        ]);
        ...
        $rows = $db->fetchAllAssociative("SELECT * FROM log_stretches WHERE instance_id = :instanceId", [
