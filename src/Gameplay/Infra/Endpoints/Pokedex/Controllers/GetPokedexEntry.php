...
use ConorSmith\Pokemon\Gameplay\Domain\Pokedex\EncounterLocation;
use ConorSmith\Pokemon\Gameplay\Domain\Evolution\EvolutionaryBranch;
...
final class GetPokedexEntry
{
    ...
    public function __invoke(Request $request, array $args): Response
    {
        ...
        return new Response($this->templateEngine->render(__DIR__ . "/../Templates/Entry.php", [
            'pokemon'            => PokemonEntryVm::create($entry, $config),
    ...
    private function findEncounterLocations(PokemonEntry $entry): array
    {
        ...
        foreach ($this->wildEncounterConfigRepository->allByRegion() as $regionId => $regionEncountersConfig) {
