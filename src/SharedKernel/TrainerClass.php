...
final class TrainerClass
{
    ...
    {
        return match($id) {
            self::BUG_CATCHER       => "/assets/trainers/Spr_FRLG_Bug_Catcher.png",
            self::CAMPER            => "/assets/trainers/Spr_FRLG_Camper.png",
            self::GYM_LEADER        => null,
            self::BLACK_BELT        => "/assets/trainers/Spr_FRLG_Black_Belt.png",
            ...
            self::YOUNGSTER         => "/assets/trainers/Spr_FRLG_Youngster.png",
            self::SUPER_NERD        => "/assets/trainers/Spr_FRLG_Super_Nerd.png",
            self::HIKER             => "/assets/trainers/Spr_FRLG_Hiker.png",
            ...
            self::ENGINEER          => "/assets/trainers/Spr_FRLG_Engineer.png",
            self::GENTLEMAN         => "/assets/trainers/Spr_FRLG_Gentleman.png",
            self::FISHERMAN         => match($gender) {
                Gender::MALE => "/assets/trainers/Spr_FRLG_Fisherman.png",
                default      => "/assets/trainers/Spr_FRLG_Fisherman.png",
            },
            self::GAMER             => "/assets/trainers/Spr_FRLG_Gamer.png",
            self::POKEMANIAC        => "/assets/trainers/Spr_FRLG_Pok%C3%A9Maniac.png",
            self::CHANNELER         => "/assets/trainers/Spr_FRLG_Channeler.png",
            self::TWINS             => "/assets/trainers/Spr_FRLG_Twins.png",
            self::BIKER             => "/assets/trainers/Spr_FRLG_Biker.png",
            self::BOSS              => "/assets/trainers/Spr_FRLG_Giovanni.png",
            self::YOUNG_COUPLE      => "/assets/trainers/Spr_FRLG_Young_Couple.png",
            self::CUE_BALL          => "/assets/trainers/Spr_FRLG_Cue_Ball.png",
            self::BIRD_KEEPER       => "/assets/trainers/Spr_FRLG_Bird_Keeper.png",
            self::ROCKER            => "/assets/trainers/Spr_FRLG_Rocker.png",
            self::BEAUTY            => "/assets/trainers/Spr_FRLG_Beauty.png",
            self::CRUSH_KIN         => "/assets/trainers/Spr_FRLG_Crush_Kin.png",
            self::JUGGLER           => "/assets/trainers/Spr_FRLG_Juggler.png",
            ...
            self::BURGLAR           => "/assets/trainers/Spr_FRLG_Burglar.png",
            self::COOL_COUPLE       => "/assets/trainers/Spr_FRLG_Cool_Couple.png",
            self::CRUSH_GIRL        => "/assets/trainers/Spr_FRLG_Crush_Girl.png",
            ...
            self::RUIN_MANIAC       => "/assets/trainers/Spr_FRLG_Ruin_Maniac.png",
            self::SAGE              => "/assets/trainers/Spr_HGSS_Sage.png",
            self::FIREBREATHER      => "/assets/trainers/Spr_HGSS_Firebreather.png",
            ...
            self::MEDIUM            => "/assets/trainers/Spr_HGSS_Medium.png",
            self::KIMONO_GIRL       => "/assets/trainers/Spr_HGSS_Kimono_Girl.png",
            self::GUITARIST         => "/assets/trainers/Spr_RS_Guitarist.png",
            self::TEACHER           => "/assets/trainers/Spr_HGSS_Teacher.png",
            self::MYSTICALMAN       => "/assets/trainers/Spr_HGSS_Eusine.png",
            self::DOUBLE_TEAM       => "/assets/trainers/Spr_HGSS_Double_Team.png",
            self::SKIER             => "/assets/trainers/Spr_HGSS_Skier.png",
            self::BOARDER           => "/assets/trainers/Spr_HGSS_Boarder.png",
            ...
            self::BATTLE_GIRL       => "/assets/trainers/Spr_RS_Battle_Girl.png",
            self::COLLECTOR         => "/assets/trainers/Spr_RS_Collector.png",
            self::INTERVIEWER       => "/assets/trainers/Spr_RS_Interviewer.png",
            self::MAGMA_ADMIN       => "/assets/trainers/Spr_RS_Tabitha.png",
            self::MAGMA_LEADER      => "/assets/trainers/Spr_RS_Maxie.png",
            self::AQUA_ADMIN        => "/assets/trainers/Spr_RS_Matt.png",
            self::AQUA_LEADER       => "/assets/trainers/Spr_RS_Archie.png",
            self::EXPERT            => "/assets/trainers/Spr_RS_Expert_F.png",
            self::KINDLER           => "/assets/trainers/Spr_RS_Kindler.png",
            self::NINJA_BOY         => "/assets/trainers/Spr_RS_Ninja_Boy.png",
            self::PARASOL_LADY      => "/assets/trainers/Spr_RS_Parasol_Lady.png",
            self::TEAMMATES         => "/assets/trainers/Spr_RS_Sr_and_Jr.png",
            self::OLD_COUPLE        => "/assets/trainers/Spr_RS_Old_Couple.png",
            self::DRAGON_TAMER      => "/assets/trainers/Spr_RS_Dragon_Tamer.png",
